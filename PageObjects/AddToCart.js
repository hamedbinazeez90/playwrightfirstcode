...
async PlaceOrder(expect,prouductName)
{
  console.log("product received here in place order is "+prouductName)
...
async clickPlace()
{
    ...
    await this.page.locator(".action__submit");
  //const bool = await this.page.locator("h3:has-text('"+productName+"')");
