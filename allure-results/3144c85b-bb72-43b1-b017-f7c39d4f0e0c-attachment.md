...
Error: locator.isVisible: Error: strict mode violation: locator('h3:has-text(\'ZARA COAT 3\')') resolved to 2 elements:
    1) <h3 _ngcontent-mix-c36="">ZARA COAT 3</h3> aka getByRole('heading', { name: 'ZARA COAT' }).first()
    2) <h3 _ngcontent-mix-c36="">ZARA COAT 3</h3> aka getByRole('heading', { name: 'ZARA COAT' }).nth(1)
